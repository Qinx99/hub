  ...
  if (window.top === window.self) {
    ...
    const saReport = function () {
      ...
      xhr.open(
        ...
        document.location.origin +
          '/93791460bd4591916fae6788dd691570096e47a0e47061cdead407edc2363560/log',
        true
      );
    ...
    const applyYouTube = function () {
      ...
      xhr.open(
        'POST',
        document.location.origin +
          '/93791460bd4591916fae6788dd691570096e47a0e47061cdead407edc2363560/ytconf',
        true
      );
      xhr.send(JSON.stringify(body));
      xhr.onreadystatechange = function () {
        ...
        if (this.status === 200 && xhr.responseText) {
          ...
          console.log(
            '[LS Filter] YouTube settings -> ' + JSON.stringify(ytSettings)
          );
    ...
    const killMiniPlayers = function () {
      ...
      document.querySelectorAll('div#mouseover-overlay').forEach((d) => {
        d.remove();
      });
    ...
    const configureYoutube = function (ytSettings) {
      ...
      if (ytSettings.hide_sidebar) {
        ...
        style.innerText +=
          '.watch-sidebar, .ytd-watch-next-secondary-results-renderer {display: none !important;}\n';
      }
      if (ytSettings.hide_comments) {
        console.debug('[LS Filter] hide comments');
        style.innerText +=
          '#watch-discussion, .watch-discussion, ytd-comments {display: none !important;}\n';
      }
      if (style.innerText !== '') {
    ...
    const blockYTImg =
      '/93791460bd4591916fae6788dd691570096e47a0e47061cdead407edc2363560/blocked-image-search.png';
    ...
    1: [
      function (require, module, exports) {
        ...
        const setupFlagScanning = function (terms, ignoredSites, mode) {
          if (window.relay_log === 'debug') {
            console.debug('[LS Filter] setup flag scanning');
          }
          if (!Array.isArray(ignoredSites)) {
            ignoredSites = [];
          }
          if (terms && terms.length > 0) {
            if (window.relay_log === 'debug') {
              console.debug('[LS Filter] terms found');
            }
            let scanInterval;
                  ...
                  if (flagger.google) {
                    ...
                    window.XMLHttpRequest.prototype.send = function (data) {
                      if (this._url.includes('assistwriting')) {
                        ...
                        if (e) e.value = decodeURIComponent(data);
                      }
                  ...
                  const scanAndReport = () => {
                    ...
                    try {
                      ...
                      if (flagger.google) {
                        ...
                        if (title) text += title.getAttribute('content');
                      ...
                      if (Array.isArray(flags) && flags.length > 0) {
                        if (window.relay_log === 'debug') {
                          console.debug(
                            '[LS Filter] scanning found flags, reporting them: ',
                            flags
                          );
                        }
        ...
        setupFlagScanning(
          [],
          { 'docs.google.com': { matcher: 'docs.google.com', mode: 'page' } },
          'intent'
        );
      },
      { './in_page/in_page_flags': 5 },
    ],
    2: [
      function (require, module, exports) {
        class FacebookFlags {
      ...
      function (require, module, exports) {
        ...
        class Flags {
          ...
          ScanValue(value) {
            ...
            if (toReport.length > 0) this.Report(toReport);
          }
          ...
          Initialize(terms, ignoredSites, mode) {
            ...
            if (!Array.isArray(ignoredSites)) {
              throw new Error('ignoredSites required');
            }
          ...
          SiteMatchers() {
            if (typeof this.siteMatchers !== 'undefined') {
              return this.siteMatchers;
            }
            if (!Boolean(this.initialized)) {
          ...
          Scan(input, flagExisting) {
            ...
            this.terms.forEach((args) => {
              ...
              if (
                ...
                if (
                  typeof this.reportedTerms[this.url.href][args.term] ===
                  'undefined'
                ) {
          ...
          Report(flags) {
            ...
            xhr.open(
              'POST',
              document.location.origin +
                '/93791460bd4591916fae6788dd691570096e47a0e47061cdead407edc2363560/log_flag',
              true
            );
            if (window.relay_log === 'debug') {
