...
(function () {
  ...
  var XY = (function () {
    ...
    XY.prototype.scale = function scale(sx) {
      var sy =
        arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : sx;
  ...
  var Brambles = (function (_Entity) {
    ...
    function Brambles() {
      ...
      return _possibleConstructorReturn(
        this,
        _Entity.call(this, { ch: '%', fg: '#483', name: 'dense brambles' })
      );
    }
  ...
  var Princess = (function (_Entity2) {
    ...
    function Princess() {
      ...
      var _this4 = _possibleConstructorReturn(
        this,
        _Entity2.call(this, { ch: 'P', fg: '#ff0', name: 'princess' })
      );
  ...
  var Pillar = (function (_Entity3) {
    ...
    function Pillar() {
      ...
      var _this5 = _possibleConstructorReturn(
        this,
        _Entity3.call(this, { ch: 'T', fg: '#fff', name: 'pillar' })
      );
  ...
  var Floor = (function (_Entity4) {
    ...
    function Floor() {
      ...
      return _possibleConstructorReturn(
        this,
        _Entity4.call(this, { ch: '.', fg: '#aaa', name: 'stone floor' })
      );
    }
  ...
  var Wall = (function (_Entity5) {
    ...
    function Wall() {
      ...
      var _this7 = _possibleConstructorReturn(
        this,
        _Entity5.call(this, { ch: '#', fg: '#666', name: 'solid wall' })
      );
  ...
  var Grass = (function (_Entity6) {
    ...
    function Grass(ch) {
      ...
      return _possibleConstructorReturn(
        this,
        _Entity6.call(this, { ch: ch, fg: '#693' })
      );
    }
  ...
  var Tree = (function (_Entity7) {
    ...
    function Tree() {
      ...
      return _possibleConstructorReturn(
        this,
        _Entity7.call(this, { ch: 'T', fg: 'green' })
      );
    }
  ...
  var Staircase = (function (_Entity9) {
    ...
    function Staircase(up, callback) {
      ...
      var _this11 = _possibleConstructorReturn(
        this,
        _Entity9.call(this, { ch: ch, fg: fg, name: name })
      );
  ...
  var Being = (function (_Entity10) {
    ...
    Being.prototype.describeVerb = function describeVerb(verb) {
      return (
        '' +
        verb +
        (verb.charAt(verb.length - 1) == 's' || verb == 'do' ? 'es' : 's')
      );
    };
  ...
  var COLORS =
    ((_COLORS = {}),
    (_COLORS[ATTACK_1] = '#0f0'),
    (_COLORS[ATTACK_2] = '#f00'),
    (_COLORS[MAGIC_1] = '#00f'),
    (_COLORS[MAGIC_2] = '#ff3'),
    _COLORS);
  ...
  var SUFFIXES =
    ((_SUFFIXES = {}),
    (_SUFFIXES[ATTACK_1] = 'power'),
    (_SUFFIXES[ATTACK_2] = 'treachery'),
    (_SUFFIXES[MAGIC_1] = 'magical domination'),
    (_SUFFIXES[MAGIC_2] = 'magical weakness'),
    _SUFFIXES);
  ...
  var Drinkable = (function (_Item) {
    ...
    function Drinkable(strength, visual) {
      ...
      if (ROT.RNG.getUniform() > 0.5) {
        ...
        _this14._visual.name =
          (diff > 0 ? 'strong' : 'weak') + ' ' + _this14._visual.name;
      }
      return _this14;
    }
  ...
  var HealthPotion = (function (_Drinkable) {
    ...
    function HealthPotion() {
      ...
      return _possibleConstructorReturn(
        this,
        _Drinkable.call(this, POTION_HP, {
          ch: '!',
          fg: '#e00',
          name: 'health potion',
        })
  ...
  var Lutefisk = (function (_Drinkable2) {
    ...
    function Lutefisk() {
      ...
      var _this25 = _possibleConstructorReturn(
        this,
        _Drinkable2.call(this, 0, { ch: '?', fg: '#ff0', name: 'lutefisk' })
      );
  ...
  var ManaPotion = (function (_Drinkable3) {
    ...
    function ManaPotion() {
      ...
      return _possibleConstructorReturn(
        this,
        _Drinkable3.call(this, POTION_MANA, {
          ch: '!',
          fg: '#00e',
          name: 'mana potion',
        })
  ...
  var Gold = (function (_Item3) {
    ...
    function Gold() {
      ...
      var _this27 = _possibleConstructorReturn(
        this,
        _Item3.call(this, 'gold', { ch: '$', fg: '#fc0', name: 'golden coin' })
      );
  ...
  var Rat = (function (_Autonomous) {
    ...
    function Rat() {
      ...
      var _this29 = _possibleConstructorReturn(
        this,
        _Autonomous.call(this, { ch: 'r', fg: '#aaa', name: 'rat' })
      );
  ...
  var Bat = (function (_Autonomous2) {
    ...
    function Bat() {
      ...
      var _this30 = _possibleConstructorReturn(
        this,
        _Autonomous2.call(this, { ch: 'b', fg: '#a83', name: 'bat' })
      );
  ...
  var Goblin = (function (_Autonomous3) {
    ...
    function Goblin() {
      ...
      var _this31 = _possibleConstructorReturn(
        this,
        _Autonomous3.call(this, { ch: 'g', fg: '#33a', name: 'goblin' })
      );
  ...
  var Orc = (function (_Autonomous4) {
    ...
    function Orc() {
      ...
      var _this32 = _possibleConstructorReturn(
        this,
        _Autonomous4.call(this, { ch: 'o', fg: '#3a3', name: 'orc' })
      );
  ...
  var OrcWitch = (function (_Autonomous5) {
    ...
    function OrcWitch() {
      ...
      var _this33 = _possibleConstructorReturn(
        this,
        _Autonomous5.call(this, { ch: 'O', fg: '#33a', name: 'orcish witch' })
      );
  ...
  var Skeleton = (function (_Autonomous6) {
    ...
    function Skeleton() {
      ...
      var _this34 = _possibleConstructorReturn(
        this,
        _Autonomous6.call(this, { ch: 's', fg: '#eee', name: 'skeleton' })
      );
  ...
  var Ogre = (function (_Autonomous7) {
    ...
    function Ogre() {
      ...
      var _this35 = _possibleConstructorReturn(
        this,
        _Autonomous7.call(this, { ch: 'O', fg: '#3a3', name: 'ogre' })
      );
  ...
  var Zombie = (function (_Autonomous8) {
    ...
    function Zombie() {
      ...
      return _possibleConstructorReturn(
        this,
        _Autonomous8.call(this, { ch: 'z', fg: '#d3d', name: 'zombie' })
      );
    }
  ...
  var Spider = (function (_Autonomous9) {
    ...
    function Spider() {
      ...
      var _this37 = _possibleConstructorReturn(
        this,
        _Autonomous9.call(this, { ch: 's', fg: '#c66', name: 'spider' })
      );
  ...
  var Snake = (function (_Autonomous10) {
    ...
    function Snake() {
      ...
      var _this38 = _possibleConstructorReturn(
        this,
        _Autonomous10.call(this, {
          ch: 's',
          fg: '#6c6',
  ...
  var Tree$1 = (function (_Autonomous12) {
    ...
    function Tree$1() {
      ...
      var _this40 = _possibleConstructorReturn(
        this,
        _Autonomous12.call(this, { ch: 'T', fg: '#3c3', name: 'animated tree' })
      );
  ...
  var Hero = (function (_Autonomous13) {
    ...
    function Hero() {
      ...
      var _this41 = _possibleConstructorReturn(
        this,
        _Autonomous13.call(this, visual)
      );
  ...
  var COMBAT_OPTIONS =
    ((_COMBAT_OPTIONS = {}),
    (_COMBAT_OPTIONS[ATTACK_1] = 2),
    (_COMBAT_OPTIONS[ATTACK_2] = 2),
    (_COMBAT_OPTIONS[MAGIC_1] = 2),
    (_COMBAT_OPTIONS[MAGIC_2] = 2),
    _COMBAT_OPTIONS);
  ...
  var PC = (function (_Being2) {
    ...
    function PC() {
      ...
      var _this42 = _possibleConstructorReturn(
        this,
        _Being2.call(this, { ch: '@', fg: '#fff', name: 'you' })
      );
    ...
    PC.prototype.handleMessage = function handleMessage(
      message,
      publisher,
      data
    ) {
    ...
    PC.prototype.moveTo = function moveTo(xy, level) {
      ...
      if (cell == BRAMBLES && ROT.RNG.getUniform() < BRAMBLE_CHANCE) {
        add$1(
          'You make your way through %s. Ouch! You injure yourself on a thorn.',
          cell
        );
        this.adjustStat('hp', -1);
      }
    ...
    PC.prototype._move = function _move(xy) {
      ...
      if (entity.blocks >= BLOCKS_MOVEMENT) {
        ...
        if (entity instanceof Door && !TUTORIAL.door) {
          TUTORIAL.door = true;
          add$1(
            'To interact with stuff, press both a {#fff}modifier key{} (Ctrl, Alt, Shift or Command) and a {#fff}direction key{} (used for movement).'
          );
        }
        if (entity instanceof Being && !TUTORIAL.enemy) {
          add$1(
            'If you wish to interact with beings (attack them, for example), press both a {#fff}modifier key{} (Ctrl, Alt, Shift or Command) and a {#fff}direction key{} (used for movement).'
          );
          TUTORIAL.enemy = true;
        }
        return;
  ...
  var LABELS =
    ((_LABELS = {}),
    (_LABELS[ATTACK_1] = 'You attack'),
    (_LABELS[ATTACK_2] = 'Enemy attacks'),
    (_LABELS[MAGIC_1] = 'You attack (magic)'),
    (_LABELS[MAGIC_2] = 'Enemy attacks (magic)'),
    _LABELS);
  ...
  function drawCell(xy, color, highlight) {
    ...
    CTX.font =
      '' + (bold ? 'bold ' : '') + CELL * 0.8 + 'px metrickal, monospace';
  ...
  function darken(color) {
    ...
    return ROT.Color.toRGB(
      ROT.Color.fromString(color).map(function (x) {
        return x >> 1;
      })
    );
  }
  ...
  function doDamage(attacker, defender) {
    ...
    if (options.isMagic) {
      ...
      if (attacker.mana < options.power) {
        add$1(
          '%The %{verb,do} not have enough mana to attack.',
          attacker,
          attacker
        );
        return;
    ...
    var verb = (
      options.isMagic ? '%{verb,cast} a spell at %the' : '%{verb,hit} %the'
    ...
    if (newHP > 0) {
      ...
      add$1(
        '%The ' + verb + ' and ' + amount + ' %{verb,damage} %it.',
        attacker,
        attacker,
        defender
      );
  ...
  function start(e) {
    ...
    if (!tutorial) {
      tutorial = true;
      add$1(
        'Combat in Sleeping Beauty happens by playing the {goldenrod}Game of Thorns{} on a square game board.'
      );
      add$1(
        "Match sequences ({#fff}direction keys{} and {#fff}Enter{}) of colored blocks to perform individual actions. This includes both your attacks as well as your enemy's."
      );
      add$1(
        'Note that certain items in your inventory can modify the frequency of colors on the game board.'
      );
      pause();
    }
  ...
  function fit$2() {
    ...
    for (var i = 0; i < knight.length; i++) {
      ...
      var row =
        '' + PAD + knight[i] + new Array(remain + 1).join(' ') + flower[i];
      result.push(row);
    }

    var final =
      "<span class='grass'>" + new Array(columns + 1).join('^') + '</span>';
    result.push(final);
  ...
  var Level = (function () {
    ...
    Level.prototype.activate = function activate(xy, who) {
      ...
      var beings = Object.keys(this._beings)
        .map(function (key) {
    ...
    Level.prototype._outro = function _outro(who) {
      ...
      if (gold) {
        var color = gold.getVisual().fg;
        add$1(
          'Furthermore, you were able to accumulate a total of {' +
            color +
            '}' +
            gold.amount +
            '{} golden coins.'
  ...
  function decorateBrambles(level) {
    ...
    for (var a = angle - da; a < angle + da; a += 0.01) {
      var xy = center
        .plus(new XY(Math.cos(a), Math.sin(a)).scale(dist))
        .round();
  ...
  function decorateFull(level) {
    ...
    level.rooms.forEach(function (room) {
      ...
      for (var i = 0; i < 2; i++) {
        ...
        switch (feature) {
          case 'item':
            level.setItem(xy, getItem(level.danger));
            break;
          case 'potion':
            level.setItem(xy, getPotion());
            break;
          case 'lutefisk':
            level.setItem(xy, new Lutefisk());
            break;
          case 'gold':
            level.setItem(xy, new Gold());
            break;
          case 'enemy':
            getBeing(level.danger).moveTo(xy, level);
            break;
          case 'hero':
            new Hero().moveTo(xy, level);
            break;
        }
      }
    });
  ...
  function decorateRegular(level) {
    ...
    if (d in levels) {
      var down = new Staircase(
        false,
        staircaseCallback(level.danger - 1, false)
      );
  ...
  function connect(level, room1, room2) {
    ...
    var overlapHorizontal = !(
      room1.lt.x > room2.rb.x || room2.lt.x > room1.rb.x
    );
  ...
  function connectWithClosest(room, level) {
    var COMPARE = function COMPARE(r1, r2) {
      return (
        r1.center.minus(room.center).norm() -
        r2.center.minus(room.center).norm()
      );
    };
